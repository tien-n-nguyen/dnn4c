...
\author{\IEEEauthorblockN{Anh Tuan Nguyen$^*$~\thanks{$^*$The research work was done while the author was a Ph.D. student with Dr. Tien N. Nguyen}}
...
%
We adapted a context-incorporating method to use with syntactic
...
\input{saner18-intro}
%\input{structure}
\input{msr17-background}
\input{msr17-context}
\input{msr17-dnnmodel}
%\input{bayesmodel}
%\input{features}
\input{msr17-evaluation}
\input{msr17-related}
...
achieves up to 25.2\% higher accuracy than the state-of-the-art LMs.
